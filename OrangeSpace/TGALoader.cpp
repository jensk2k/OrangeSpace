...
bool LoadTGA(Texture * texture, char * filename)				// Load a TGA file
{
	...
	{
		Debug::Log("ERROR: Could not open texture file");
	...
	{
		Debug::Log("ERROR: Could not read file header");
	...
	{
		Debug::Log("ERROR: Invalid Image. TGA file be type 2 or type 10. ");
...
{																			// TGA Loading code nehe.gamedev.net)
	...
	{										
		Debug::Log("ERROR: Could not read info header");
	...
	{
		Debug::Log("ERROR: Invalid texture information");
	...
	{
		Debug::Log("ERROR: Could not allocate memory for image");
	...
	{
		Debug::Log("ERROR: Could not read image data");
...
{ 
	...
	do
	{
		...
		{
			Debug::Log("ERROR: Could not read RLE header");
		...
		{																	// that follow the header
			...
			for(short counter = 0; counter < chunkheader; counter++)		// Read RAW color values
			{
				...
				{
					Debug::Log("ERROR: Too many pixels read");
		...
		else																			// chunkheader > 128 RLE data, next color reapeated chunkheader - 127 times
		{
			...
			{	
				Debug::Log("ERROR: Could not read from file");
